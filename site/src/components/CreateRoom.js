                            ...
                            <form onSubmit={createHandler}>
                                <div className="form-row">
                                    ...
                                    <div className="control-group col-sm-6">
                                        ...
                                        <input type="text" className="form-control" name="size" required="required" />
                                    </div>
                                    <div className="control-group col-sm-6">
                                        <label>Брой легла</label>
                                        <input type="text" className="form-control" name="beds" required="required" />
                                    </div>
                                    <div className="control-group col-sm-6">
                                    ...
                                    <div className="control-group col-sm-6">
                                        ...
                                        <input type="text" className="form-control" name="img2" required="required" />
                                    </div>
                                    <div className="control-group col-sm-6">
                                        <label>Снимка 3</label>
                                        <input type="text" className="form-control" name="img3" required="required" />
                                    </div>
                                    <div className="control-group col-sm-6">
                                        <label>Снимка 4</label>
                                        <input type="text" className="form-control" name="img4" required="required" />
                                    </div>
                                    <div className="control-group col-sm-6">
                                        <label>Снимка 5</label>
                                        <input type="text" className="form-control" name="img5" required="required" />
                                    </div>
                                    <div className="control-group col-sm-6">
                                        <label>Снимка 6</label>
                                        <input type="text" className="form-control" name="img6" required="required" />
                                    </div>
                                </div>
